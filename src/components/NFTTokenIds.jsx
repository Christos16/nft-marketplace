...
function NFTTokenIds({ inputValue, setInputValue }) {
  ...
  return (
    <>
      {inputValue === "explore" && <div className="mt-4">
        <TopSection />
      </div>}
      ...
      <div className="">
        ...
        {inputValue !== "explore" && totalNFTs !== undefined && (
          <>
            ...
            <CollectionDetails collectionSize={totalNFTs} handleBuyClick={handleBuyClick} getMarketItem={getMarketItem} fetchMarketItems={fetchMarketItems} chainId={chainId} collection={NFTTokenIds} />
        ...
        <div>
          {inputValue === "explore" &&
            <Collection nftCollections={NFTCollections} setInputValue={setInputValue} />
          }
      ...
      {inputValue === "explore" && <Creators />}
      {inputValue === "explore" && <CallToAction />}
    </>
  );
}
